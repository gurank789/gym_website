    ...
    <div className={styles.main}>
      <form className={styles.form} onSubmit={handelSubmit}>
        ...
        <input
          ...
          name="phoneNumber"
        />
        <p className={styles.errorMessage}>{error.phoneNumber}</p>
        ...
        <h2>{isuserPresent ? "User already exists. Please login." : ""}</h2>
        <h2>{isregister ? "Registration successful." : ""}</h2>
      </form>
      <div>
        <img
          className={styles.sideimg}
          src="https://c4.wallpaperflare.com/wallpaper/208/630/413/bodybuilding-computer-download-wallpaper-preview.jpg"
          alt="demo"
        />
      </div>
    </div>
